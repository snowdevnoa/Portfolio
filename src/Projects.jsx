...
function Projects() {
	...
	const uiTypes = PROJECT_TYPES.map((type) => (
		<div
			className="mb-10 w-full md:w-1/2 lg:w-1/4 project-type items-center"
			key={type}
		>
	...
	return (
		<Container>
			<div
				...
				id="projects"
			>
				<div className="w-full min-h-[100px] text-xl flex flex-col items-center md:flex-row md:flex-wrap mt-[4rem] md:mt-[8rem] md:justify-evenly animate-hide mb-3">
					{uiTypes}
				</div>
